...
export function AboutCardSkeleton() {
  return (
    <div
      ...
      <div className={`${shimmer} col-span-2 size-6 h-6 w-28 justify-self-center rounded-md bg-gray-600`} />
      <div className={`${shimmer} h-4 rounded-md w-16 bg-gray-600`} />
      <div className={`${shimmer} h-4 rounded-md w-16 bg-gray-600 justify-self-end`} />
...
export function AboutPageSkeleton() {
  return (
    <div className="pt-1 flex flex-col justify-center items-center space-y-3">
      ...
      <div className="h-3 w-7/12 bg-gray-600 rounded-md"/><br/>
      <div className="h-40 w-1/2 bg-gray-600 rounded-md"/>
    </div>
  )
}